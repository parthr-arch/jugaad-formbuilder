(function () {
  ...
  class TwoColumnsComponent extends ColumnsComponent {
    ...
    static get builderInfo() {
      return {
        title: 'Two Columns',
        group: 'layout',
        icon: 'columns', // Icon for two columns
        weight: 10,
        schema: TwoColumnsComponent.schema(),
      };
    }

    get defaultSchema() {
      return TwoColumnsComponent.schema();
    }
  ...
  TwoColumnsComponent.editForm = function () {
  ...
  Formio.Components.addComponent('twocolumns', TwoColumnsComponent);
})();
